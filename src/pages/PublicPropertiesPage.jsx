        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600">Explora nuestras propiedades en renta</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">Vuelve pronto para ver nuevas opciones</p>
          </div>
        ) : (
          <>
            <div className="mb-6">
      ...
      <div className="bg-white border-t border-gray-200 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-sm text-gray-600">
            <p>¿Interesado en alguna propiedad? <button onClick={() => navigate('/login')} className="text-blue-600 hover:text-blue-700 font-medium">Inicia sesión</button> para más información</p>
          </div>
        </div>
      </div>
    </div>

...
//console.log('docs', docs)
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
      ...
      {(property.use === 'rental' || property.use === 'commercial') && (   
      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 ">
        <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Rental Type</div>
        <div className="text-xl font-semibold text-gray-900">{property.rental_type ? property.rental_type.charAt(0).toUpperCase() + property.rental_type.slice(1) : 'Not Rented'}</div>
      </div>
)}
    </div>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {property.media[selectedMediaIndex].url && (
                              ...
                              type='button'
                                ...
                                className="cursor-pointer inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-700 font-medium"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex justify-between items-start gap-3 mb-2">
                          ...
                          {law.id && (
                            <button
                              ...
                              className="cursor-pointer text-red-600 hover:text-red-700 text-xs font-medium"
                            >
                              Delete
                            </button>
                          )}
                      ...
                      <div key={doc.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        ...
                        {doc.canDeleteMonthlyDocument && (
                          <button
                            ...
                            className="cursor-pointer inline-flex items-center gap-2 text-sm text-red-600 hover:text-red-700 font-medium ml-4"
                          >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg>
